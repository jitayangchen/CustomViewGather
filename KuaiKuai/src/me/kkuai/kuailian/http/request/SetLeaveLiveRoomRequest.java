...
public class SetLeaveLiveRoomRequest extends K_Request {
	
	public SetLeaveLiveRoomRequest(OnDataBack callback) {
		this.callback = callback;
		this.REQUEST_TYPE = HttpRequestTypeId.TASKID_SET_USER_LEAVE_ROOM;
		this.URL = HttpRequestUrl.SET_USER_LEAVE_ROOM;
	}
	...
	public void setLeaveRoom(String roomId) {
