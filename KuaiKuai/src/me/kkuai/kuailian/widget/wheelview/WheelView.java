...
package me.kkuai.kuailian.widget.wheelview;
...
//		if(getScreenWidth(context) > 560){
//			ADDITIONAL_ITEM_HEIGHT = 60;
//		}
	}
...
//					| Paint.FAKE_BOLD_TEXT_FLAG | Paint.DITHER_FLAG);
		...
		//	centerDrawable = getContext().getResources().getDrawable(R.drawable.wheel_val);
			centerDrawable = getContext().getResources().getDrawable(R.drawable.bg_wheel_glass);
		}
	...
	private int getDesiredHeight(Layout layout) {
		...
		int desired = getItemHeight() * visibleItems - ITEM_OFFSET - ADDITIONAL_ITEM_HEIGHT;
		
		if (screenWidth > 560)
			desired = getItemHeight() * visibleItems - ITEM_OFFSET * 2 - ADDITIONAL_ITEM_HEIGHT;
	...
	void finishScrolling() {
		...
		for (OnWheelChangedListener listener : changingListeners) {
			listener.onFinishScroll(isScrollingPerformed);
		}
	}
