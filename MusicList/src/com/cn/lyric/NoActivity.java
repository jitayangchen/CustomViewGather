...
public class NoActivity extends Activity {
	...
	protected void showo() {
		if (!isview) {
			MusicPlayingActivity.music_equze.startAnimation(myAnimation);
			MusicPlayingActivity.imageBtnRandom.startAnimation(myAnimation);
			MusicPlayingActivity.music_equze.setVisibility(View.VISIBLE);
			MusicPlayingActivity.imageBtnRandom.setVisibility(View.VISIBLE);
			isview = true;
		} else {
			MusicPlayingActivity.music_equze.startAnimation(myAnimationbbb);
			MusicPlayingActivity.music_equze.setVisibility(View.INVISIBLE);
			MusicPlayingActivity.imageBtnRandom.startAnimation(myAnimationbbb);
			MusicPlayingActivity.imageBtnRandom.setVisibility(View.INVISIBLE);
			isview = false;
		}
	}
