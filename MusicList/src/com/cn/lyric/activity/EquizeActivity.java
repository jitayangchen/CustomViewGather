...
import com.cn.ui.custom.MySeekBar;
import com.cn.ui.custom.ScreenInfo;
import com.cn.ui.custom.MySeekBar.OnSeekBarChangeListener;
import com.example.musiclist.R;

public class EquizeActivity extends Activity {
	private Close close;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ScreenInfo s = new ScreenInfo(EquizeActivity.this);
			...
			bar[n].setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
				...
				public void onProgressChanged(MySeekBar VerticalSeekBar,
					...
					if (MusicService.player != null) {
						Intent intent = new Intent(EquizeActivity.this,
								MusicService.class);
		...
		equzechoosebut.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				choose = true;
				new AlertDialog.Builder(EquizeActivity.this)
