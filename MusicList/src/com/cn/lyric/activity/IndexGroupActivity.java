...
public class IndexGroupActivity extends ActivityGroup {
...
//				}
		...
		s = new ScreenInfo(IndexGroupActivity.this);
		screenW = s.getWidth();
		...
		this.registerReceiver(closeReceiver, filter22);
	...
	void InItView() {
		...
		View view01 = getLocalActivityManager().startActivity("activity01",
				new Intent(this, com.cn.lyric.activity.TabIMainActivity.class))
				.getDecorView();
		View view02 = getLocalActivityManager().startActivity("activity02",
				new Intent(this, com.cn.lyric.activity.TabArtistsActivity.class))
				.getDecorView();
		View view03 = getLocalActivityManager().startActivity("activity03",
				new Intent(this, com.cn.lyric.activity.TabListActivity.class))
				.getDecorView();
		View view04 = getLocalActivityManager().startActivity("activity04",
				new Intent(this, com.cn.lyric.activity.TabOnlineActivity.class))
				.getDecorView();
	...
	public class OnClickListener implements android.view.View.OnClickListener {
		...
		public void onClick(View v) {
			if (v == relative_main) {
				Intent intent3 = new Intent(IndexGroupActivity.this, MusicPlayingActivity.class);
				...
				if (lists.size() > 0) {
					...
					// 播放
					Intent intents = new Intent(IndexGroupActivity.this, MusicService.class);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (item.getItemId() == R.id.about) {
			Intent intent1 = new Intent(IndexGroupActivity.this, AboutActivity.class);
		...
		if (item.getItemId() == R.id.deletecurrent) {
			if (MusicService.nowplay) {
				...
				if (f.exists()) {
					...
					MusicNum.putint(3);
					Intent intent = new Intent(IndexGroupActivity.this, MusicService.class);
					MusicNum.putplay(5);
					MusicNum.putisok(true);
					startService(intent);
		...
		if (item.getItemId() == R.id.entersleep) {
			Intent intent1 = new Intent(IndexGroupActivity.this, SleepActivity.class);
			startActivity(intent1);
		}
		if (item.getItemId() == R.id.menusearch) {
			Intent intent1 = new Intent(IndexGroupActivity.this, ListOfSearchActivity.class);
			startActivity(intent1);
		}
		if (item.getItemId() == R.id.setting) {
			Intent intent1 = new Intent(IndexGroupActivity.this, SettingActivity.class);
			startActivity(intent1);
		}
		if(item.getItemId() == R.id.more){
			AppConnect.getInstance(this).showAppOffers(this);
		}
		if (item.getItemId() == R.id.settingring) {//设置铃声
			if (MusicService.player == null) {
