...
import com.cn.lyric.adapter.AlbumsAdapter;
 ...
 */
public class ListOfAlbumsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		musiclist_play.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				Intent intent = new Intent(ListOfAlbumsActivity.this,
		...
		albumListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				Intent intent1 = new Intent(ListOfAlbumsActivity.this,
						MusicService.class);
				MusicNum.putplay(8);
