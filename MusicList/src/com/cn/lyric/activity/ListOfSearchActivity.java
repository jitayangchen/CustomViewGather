 ...
 */
public class ListOfSearchActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		MusicAdapter adapter = new MusicAdapter(ListOfSearchActivity.this, listMusic);
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				if (edit_search.getText().toString().equals("")) {
					...
					Intent intent1 = new Intent(ListOfSearchActivity.this, MusicService.class);
		...
		public void onTextChanged(CharSequence s, int start, int before,
			...
			if (edit_search.getText().toString().equals("")) {
				...
				List<Music> listMusic = MusicList2
						.getMusicData(getApplicationContext());
				MusicAdapter adapter2 = new MusicAdapter(ListOfSearchActivity.this, listMusic);
