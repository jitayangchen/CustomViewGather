...
import com.cn.lyric.adapter.ArtistsAdapter;
...
public class TabArtistsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		artistListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				Intent intent1 = new Intent(TabArtistsActivity.this,
						MusicService.class);
				MusicNum.putplay(8);
				MusicNum.putisok(true);
				intent1.putExtra("_id", musicnum[arg2]);
				startService(intent1);
				Intent intent = new Intent(TabArtistsActivity.this,
